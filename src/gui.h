...
void drawPassTimings(const PassTimings&);
void drawStats(const FPSTimer&, const GPUTimer&, const PassTimings&, const Scene&, const Camera&, const std::vector<SceneEntry>&, SceneSwitchState&,
               RenderSettings&);
}; // namespace Gui
